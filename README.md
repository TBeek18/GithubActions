...
[![Run App TrentynBeekman](https://github.com/TBeek18/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/TBeek18/GithubActions/actions/workflows/run-app.yaml)
